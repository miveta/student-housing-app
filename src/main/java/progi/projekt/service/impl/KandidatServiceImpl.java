...
/*
    ...
    public Boolean josNisuKandidat(Oglas oglas1, Oglas oglas2) {
        ...
        for (Kandidat kand1 : kandidati1) {
            ...
            if (kandStud1.equals(postojeciKandStud) || kandStud2.equals(postojeciKandStud)) {
                return false;
            }
        }
        return true;
    ...
    public void updateLocalKands() {
        ...
        for (Oglas oglas : oglasi) {
            ...
            for (Kandidat kandidat : kandidati) {
                if (kandidat.getOglas().equals(oglas) || kandidat.getKandOglas().equals(oglas)) {
