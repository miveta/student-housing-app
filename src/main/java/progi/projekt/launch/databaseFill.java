...
public class databaseFill implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    private StatusOglasaRepository statusOglasaRepository;
    @Autowired
    private TrazeniUvjetiRepository trazeniUvjetiRepository;
    @Autowired
    private ZaposlenikscRepository zaposlenikscRepository;
    @Autowired
    private StudentskiCentarRepository studentskiCentarRepository;
    ...
    @Override public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        if(studentRepository.count() == 0) {
            ...
            ivica.setLozinka("123");
            ivica.setObavijestiNaMail(false);
            ivica.setElevated(false);
            ...
            marko.setLozinka("password");
            marko.setObavijestiNaMail(false);
            marko.setElevated(false);
            ...
            pero.setLozinka("54321");
            pero.setObavijestiNaMail(false);
            pero.setElevated(false);
